...
#define STRING_CONFIG_H_AUTHOR "(wubbgmbaa, default config)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-37, -2, -2.8}
...
#define X_BED_SIZE 135.2
#define Y_BED_SIZE 164.3
